...
if __name__ == '__main__':
    ...
    filepath = f'./results/ToG-freebase/ToG-raw-{args.dataset}-{args.llm}.jsonl'
        ...
        try:
            ...
            for depth in range(1, args.depth+1):
                ...
                if len(total_candidates) ==0:
                    half_stop(question, cluster_chain_of_entities, filepath, args)
                    break
            ...
            if not flag_printed:
                ...
                save_2_jsonl(question, results, [], filepath=filepath)
